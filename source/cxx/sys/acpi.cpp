...
namespace acpi {
    namespace madt {
        prs::vector<ioapic *, prs::allocator> ioapics(arena::create_resource());
        prs::vector<iso *, prs::allocator> isos(arena::create_resource());
        prs::vector<nmi *, prs::allocator> nmis(arena::create_resource());
    };
